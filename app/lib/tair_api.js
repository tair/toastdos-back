 ...
 * /loci/{name} no longer returns JSON from www.arabidopsis.org.
 * The /loci/:name endpoint now lives on the TAIR3 backend, accessible
 * via the /api prefix (e.g. https://www.arabidopsis.org/api/loci/{name}).
 */
